...
| NO | Fungsi                         | Mata Kuliah         | Nama Aplikasi     | GNU/Linux | MS Windows | Mac OS | SMT |
|----+--------------------------------+---------------------+-------------------+-----------+------------+--------+-----|
|  1 | Generate high-quality diagrams | PEMDAS, PEMLAN, SBD | yEd               | V         | V          | V      |     |
|  2 | English-Indonesia Dictionary   | Bahasa Inggris      | gKamus            | V         | X          | X      |     |
|  3 | Wireframing tool               | IMK                 | wireframesketcher | V         | V          | V      |     |
|  4 | Design tool for UML diagrams   | APS                 | astah community   | V         | X          | X      |     |
|  5 | Draw structured diagrams       | RPL                 | dia diagram       | V         | V          | V      |     |
